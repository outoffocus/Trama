...
object NotificationConfig {
    ...
    const val CHANNEL_LISTENER = "mydiary_listener"

    /** Notifications shown when a new diary entry is captured. */
    const val CHANNEL_NEW_ENTRY = "mydiary_new_entry"

    /** Foreground notification for the recording service. */
    const val CHANNEL_RECORDING = "mydiary_recording"

    /** Notification for daily summary results. */
    const val CHANNEL_DAILY_SUMMARY = "mydiary_daily_summary"
