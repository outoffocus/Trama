...
class MigrationTest {
    ...
    @Test
    fun `MIGRATION_12_13 has correct version range`() {
        val migration = DiaryDatabase.MIGRATION_12_13
    ...
    @Test
    fun `migrations form a continuous chain from version 1 to 20`() {
        ...
        // Verify chain starts at 1 and ends at 20
        assertEquals(1, migrations.first().startVersion)
        assertEquals(20, migrations.last().endVersion)
    }
