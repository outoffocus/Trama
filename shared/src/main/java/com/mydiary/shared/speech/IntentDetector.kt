...
/**
 * Detects semantic intents in transcribed speech using regex patterns.
 *
 * Replaces exact keyword matching with flexible pattern matching that captures
 * natural language variations. For example, the "pendiente" pattern matches
 * "tengo que", "tendría que", "hay que", "debería", "necesito", etc.
 *
